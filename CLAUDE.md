...
- **Do not ** install any NuGet or Python other packages automatically, always prompt the user to install packages manually.
...
- **When first ingesting a new reference or third-party project, scan it at the
  ...
  on this machine and Python is as well). Distinguish genuine threats from benign
...
- **Put all agent-related docs like session handoffs and plans in @docs/internal/agent/**
