...
- **M5 — Graph zoom.** `h`/`l` (and left/right) zoom the charts in and out — vtop's `graphScale` halves/doubles between 0.125 and 8, interpolating between samples when zoomed in and decimating when zoomed out.
