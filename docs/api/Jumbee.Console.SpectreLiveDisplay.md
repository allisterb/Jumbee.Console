# <a id="Jumbee_Console_SpectreLiveDisplay"></a> Class SpectreLiveDisplay
...
```csharp
public class SpectreLiveDisplay : Control, IFocusable
```
...
[ControlExtensions.WithAsciiBorder<SpectreLiveDisplay\>\(SpectreLiveDisplay, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<SpectreLiveDisplay\>\(SpectreLiveDisplay, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<SpectreLiveDisplay\>\(SpectreLiveDisplay, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<SpectreLiveDisplay\>\(SpectreLiveDisplay, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<SpectreLiveDisplay\>\(SpectreLiveDisplay, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<SpectreLiveDisplay\>\(SpectreLiveDisplay, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<SpectreLiveDisplay\>\(SpectreLiveDisplay, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<SpectreLiveDisplay\>\(SpectreLiveDisplay, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<SpectreLiveDisplay\>\(SpectreLiveDisplay, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<SpectreLiveDisplay\>\(SpectreLiveDisplay\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<SpectreLiveDisplay\>\(SpectreLiveDisplay, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<SpectreLiveDisplay\>\(SpectreLiveDisplay, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<SpectreLiveDisplay\>\(SpectreLiveDisplay, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<SpectreLiveDisplay\>\(SpectreLiveDisplay, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<SpectreLiveDisplay\>\(SpectreLiveDisplay, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<SpectreLiveDisplay\>\(SpectreLiveDisplay, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<SpectreLiveDisplay\>\(SpectreLiveDisplay, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<SpectreLiveDisplay\>\(SpectreLiveDisplay, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<SpectreLiveDisplay\>\(SpectreLiveDisplay, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Constructors

### <a id="Jumbee_Console_SpectreLiveDisplay__ctor_Spectre_Console_Rendering_IRenderable_"></a> SpectreLiveDisplay\(IRenderable\)

Initializes a new <xref href="Jumbee.Console.SpectreLiveDisplay" data-throw-if-not-resolved="false"></xref> around the <code class="paramref">target</code> renderable it live-refreshes.
...
### <a id="Jumbee_Console_SpectreLiveDisplay_display"></a> display

The wrapped Spectre <xref href="Spectre.Console.LiveDisplay" data-throw-if-not-resolved="false"></xref> driving the refresh loop.
...
### <a id="Jumbee_Console_SpectreLiveDisplay_target"></a> target

The renderable being live-displayed.
...
### <a id="Jumbee_Console_SpectreLiveDisplay_Render"></a> Render\(\)

No-op: the wrapped <xref href="Spectre.Console.LiveDisplay" data-throw-if-not-resolved="false"></xref> writes to the buffer from its own refresh loop.

```csharp
protected override void Render()
```

### <a id="Jumbee_Console_SpectreLiveDisplay_Start_System_Action_Spectre_Console_LiveDisplayContext__"></a> Start\(Action<LiveDisplayContext\>\)

Runs <code class="paramref">action</code> on a background thread with a live-refreshing display context.

```csharp
public Task Start(Action<LiveDisplayContext> action)
```
...
### <a id="Jumbee_Console_SpectreLiveDisplay_StartAsync_System_Func_Spectre_Console_LiveDisplayContext_System_Threading_Tasks_Task__"></a> StartAsync\(Func<LiveDisplayContext, Task\>\)

Runs the asynchronous <code class="paramref">action</code> with a live-refreshing display context.
...
`action` Func<LiveDisplayContext, Task\>

#### Returns

 Task

### <a id="Jumbee_Console_SpectreLiveDisplay_StartAsync__1_System_Func_Spectre_Console_LiveDisplayContext_System_Threading_Tasks_Task___0___"></a> StartAsync<T\>\(Func<LiveDisplayContext, Task<T\>\>\)

Runs the asynchronous <code class="paramref">action</code> with a live-refreshing display context and returns its result.
...
`action` Func<LiveDisplayContext, Task<T\>\>
...
### <a id="Jumbee_Console_SpectreLiveDisplay_Validate"></a> Validate\(\)

No-op: the live display is treated as always needing a repaint.
