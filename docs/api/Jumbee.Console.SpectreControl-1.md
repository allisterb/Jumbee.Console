# <a id="Jumbee_Console_SpectreControl_1"></a> Class SpectreControl<T\>
...
```csharp
public class SpectreControl<T> : RenderableControl, IFocusable where T : IRenderable
```
...
[ControlExtensions.WithAsciiBorder<SpectreControl<T\>\>\(SpectreControl<T\>, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<SpectreControl<T\>\>\(SpectreControl<T\>, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<SpectreControl<T\>\>\(SpectreControl<T\>, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<SpectreControl<T\>\>\(SpectreControl<T\>, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<SpectreControl<T\>\>\(SpectreControl<T\>, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<SpectreControl<T\>\>\(SpectreControl<T\>, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<SpectreControl<T\>\>\(SpectreControl<T\>, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<SpectreControl<T\>\>\(SpectreControl<T\>, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<SpectreControl<T\>\>\(SpectreControl<T\>, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<SpectreControl<T\>\>\(SpectreControl<T\>\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<SpectreControl<T\>\>\(SpectreControl<T\>, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<SpectreControl<T\>\>\(SpectreControl<T\>, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<SpectreControl<T\>\>\(SpectreControl<T\>, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<SpectreControl<T\>\>\(SpectreControl<T\>, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<SpectreControl<T\>\>\(SpectreControl<T\>, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<SpectreControl<T\>\>\(SpectreControl<T\>, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<SpectreControl<T\>\>\(SpectreControl<T\>, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<SpectreControl<T\>\>\(SpectreControl<T\>, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<SpectreControl<T\>\>\(SpectreControl<T\>, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Remarks

Uses an <xref href="Jumbee.Console.AnsiConsoleBuffer" data-throw-if-not-resolved="false"></xref> to render the control to a buffer.
Public property setters and methods that change a control's visual state should call <xref href="Jumbee.Console.Control.Invalidate" data-throw-if-not-resolved="false"></xref> to request a re-render on the next UI update tick.
Non-atomic changes to the wrapped content (e.g. mutating its collections) should go through <xref href="Jumbee.Console.SpectreControl%601.UpdateContent(System.Action%7b%600%7d)" data-throw-if-not-resolved="false"></xref>,
which applies the change on the UI thread so it never races with rendering.

## Constructors

### <a id="Jumbee_Console_SpectreControl_1__ctor__0_"></a> SpectreControl\(T\)

Initializes a new <xref href="Jumbee.Console.SpectreControl%601" data-throw-if-not-resolved="false"></xref> wrapping the given Spectre.Console <code class="paramref">content</code>.
...
### <a id="Jumbee_Console_SpectreControl_1_Content"></a> Content

The wrapped Spectre.Console renderable; setting it requests a re-render.
...
### <a id="Jumbee_Console_SpectreControl_1_RendersInteractiveState"></a> RendersInteractiveState

Always <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">false</a> — the wrapped content's output does not depend on interactive state, so focus/hover changes reuse the cached buffer.
...
### <a id="Jumbee_Console_SpectreControl_1_Measure_Spectre_Console_Rendering_RenderOptions_System_Int32_"></a> Measure\(RenderOptions, int\)

Measures the wrapped content.
...
### <a id="Jumbee_Console_SpectreControl_1_Render_Spectre_Console_Rendering_RenderOptions_System_Int32_"></a> Render\(RenderOptions, int\)

Renders the wrapped content to segments.
...
### <a id="Jumbee_Console_SpectreControl_1_UpdateContent_System_Action__0__"></a> UpdateContent\(Action<T\>\)
...
Replaces the former copy-on-write approach now that all mutation is serialized onto the UI thread.
