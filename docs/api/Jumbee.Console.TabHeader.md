# <a id="Jumbee_Console_TabHeader"></a> Class TabHeader
...
```csharp
public class TabHeader : RenderableControl, IFocusable
```
...
[ControlExtensions.WithAsciiBorder<TabHeader\>\(TabHeader, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<TabHeader\>\(TabHeader, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<TabHeader\>\(TabHeader, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<TabHeader\>\(TabHeader, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<TabHeader\>\(TabHeader, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<TabHeader\>\(TabHeader, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<TabHeader\>\(TabHeader, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<TabHeader\>\(TabHeader, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<TabHeader\>\(TabHeader, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<TabHeader\>\(TabHeader\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<TabHeader\>\(TabHeader, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<TabHeader\>\(TabHeader, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<TabHeader\>\(TabHeader, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<TabHeader\>\(TabHeader, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<TabHeader\>\(TabHeader, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<TabHeader\>\(TabHeader, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<TabHeader\>\(TabHeader, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<TabHeader\>\(TabHeader, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<TabHeader\>\(TabHeader, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Remarks

Focusable and listener-tagging (so a click selects it and keyboard focus can land on it); renders its name styled
by active / hover / inactive state. Selecting raises <xref href="Jumbee.Console.TabHeader.Activated" data-throw-if-not-resolved="false"></xref> and closing raises
<xref href="Jumbee.Console.TabHeader.CloseRequested" data-throw-if-not-resolved="false"></xref>; tab-to-tab navigation (Alt+arrows) is handled by the owning <xref href="Jumbee.Console.TabPanel" data-throw-if-not-resolved="false"></xref>.

## Properties

### <a id="Jumbee_Console_TabHeader_ActiveStyle"></a> ActiveStyle

Style of the active (selected) tab. Defaults to <xref href="Jumbee.Console.IStyleTheme.Selection" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Jumbee_Console_TabHeader_HandlesInput"></a> HandlesInput

<a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">true</a> unless the tab is disabled: an enabled header handles Enter/Space to select.
...
### <a id="Jumbee_Console_TabHeader_HoverStyle"></a> HoverStyle

Style of a hovered inactive tab. Defaults to <xref href="Jumbee.Console.IStyleTheme.Hover" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Jumbee_Console_TabHeader_InactiveStyle"></a> InactiveStyle

Style of inactive tabs. Defaults to <xref href="Jumbee.Console.IStyleTheme.TextMuted" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Jumbee_Console_TabHeader_Index"></a> Index

This tab's position among all tabs. Kept in sync by the owning <xref href="Jumbee.Console.TabPanel" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Jumbee_Console_TabHeader_IsActive"></a> IsActive

<a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">true</a> for the currently selected tab (drawn with <xref href="Jumbee.Console.TabHeader.ActiveStyle" data-throw-if-not-resolved="false"></xref>).
...
### <a id="Jumbee_Console_TabHeader_IsEnabled"></a> IsEnabled

<a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">false</a> for a disabled tab: drawn dimmed, not focusable, ignores clicks/keys.
...
### <a id="Jumbee_Console_TabHeader_RendersOwnFocus"></a> RendersOwnFocus

<a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">true</a>: the header shows keyboard focus itself by underlining an inactive tab.
...
### <a id="Jumbee_Console_TabHeader_Text"></a> Text
...
### <a id="Jumbee_Console_TabHeader_ApplyTheme"></a> ApplyTheme\(\)
...
### <a id="Jumbee_Console_TabHeader_OnClick_ConsoleGUI_Space_Position_"></a> OnClick\(Position\)
...
### <a id="Jumbee_Console_TabHeader_OnDoubleClick_ConsoleGUI_Space_Position_"></a> OnDoubleClick\(Position\)
...
### <a id="Jumbee_Console_TabHeader_OnInput_ConsoleGUI_Input_InputEvent_"></a> OnInput\(InputEvent\)
...
### <a id="Jumbee_Console_TabHeader_Render_Spectre_Console_Rendering_RenderOptions_System_Int32_"></a> Render\(RenderOptions, int\)

Renders the tab label styled by active / hover / focus / disabled state, with the optional close (✕) slot.
...
### <a id="Jumbee_Console_TabHeader_Activated"></a> Activated

Raised when this tab is chosen — by a click or by Enter/Space while focused.
...
### <a id="Jumbee_Console_TabHeader_CloseRequested"></a> CloseRequested

Raised when the tab's close (✕) glyph is clicked (only fires when <xref href="Jumbee.Console.TabHeader.Closable" data-throw-if-not-resolved="false"></xref> and the
    glyph is shown — i.e. the tab is active or hovered).
...
The owning <xref href="Jumbee.Console.TabPanel" data-throw-if-not-resolved="false"></xref> turns this into a cancelable
    <xref href="Jumbee.Console.TabPanel.TabCloseRequested" data-throw-if-not-resolved="false"></xref>.
