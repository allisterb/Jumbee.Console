# <a id="Jumbee_Console_Spinner"></a> Class Spinner
...
```csharp
public class Spinner : AnimatedControl, IFocusable
```
...
[AnimatedControl.Start\(\)](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_Start), 
[AnimatedControl.Stop\(\)](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_Stop), 
[AnimatedControl.Dispose\(\)](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_Dispose), 
[AnimatedControl.Paint\(\)](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_Paint), 
[AnimatedControl.Validate\(\)](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_Validate), 
[AnimatedControl.frameCount](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_frameCount), 
[AnimatedControl.frameIndex](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_frameIndex), 
[AnimatedControl.lastUpdate](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_lastUpdate), 
[AnimatedControl.accumulated](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_accumulated), 
[AnimatedControl.interval](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_interval), 
[AnimatedControl.isRunning](Jumbee.Console.AnimatedControl.md\#Jumbee\_Console\_AnimatedControl\_isRunning), 
...
[ControlExtensions.WithAsciiBorder<Spinner\>\(Spinner, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<Spinner\>\(Spinner, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<Spinner\>\(Spinner, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<Spinner\>\(Spinner, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<Spinner\>\(Spinner, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<Spinner\>\(Spinner, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<Spinner\>\(Spinner, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<Spinner\>\(Spinner, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<Spinner\>\(Spinner, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<Spinner\>\(Spinner\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<Spinner\>\(Spinner, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<Spinner\>\(Spinner, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<Spinner\>\(Spinner, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<Spinner\>\(Spinner, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<Spinner\>\(Spinner, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<Spinner\>\(Spinner, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<Spinner\>\(Spinner, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<Spinner\>\(Spinner, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<Spinner\>\(Spinner, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Constructors

### <a id="Jumbee_Console_Spinner__ctor"></a> Spinner\(\)

Initializes a new <xref href="Jumbee.Console.Spinner" data-throw-if-not-resolved="false"></xref> using the default spinner style.
...
### <a id="Jumbee_Console_Spinner_SpinnerType"></a> SpinnerType

The spinner animation (frame set and interval) to cycle through.
...
### <a id="Jumbee_Console_Spinner_Style"></a> Style

The style applied to the spinner glyph and label.
...
### <a id="Jumbee_Console_Spinner_Text"></a> Text

An optional label drawn after the spinner glyph.
...
### <a id="Jumbee_Console_Spinner_Render"></a> Render\(\)

Renders the current animation frame (glyph plus label).
