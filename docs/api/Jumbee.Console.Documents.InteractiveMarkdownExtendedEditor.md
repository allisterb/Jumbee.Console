# <a id="Jumbee_Console_Documents_InteractiveMarkdownExtendedEditor"></a> Class InteractiveMarkdownExtendedEditor
...
```csharp
public class InteractiveMarkdownExtendedEditor : InteractiveSourceEditor, IFocusable
```
...
[ControlExtensions.WithAsciiBorder<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<InteractiveMarkdownExtendedEditor\>\(InteractiveMarkdownExtendedEditor, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Remarks

The left pane is a <xref href="Jumbee.Console.CodeEditor" data-throw-if-not-resolved="false"></xref> editing
Markdown (with the Mermaid grammar highlighting the contents of <code>```mermaid</code> fences); the right pane is a
<xref href="Jumbee.Console.Documents.MarkdownExtendedViewer" data-throw-if-not-resolved="false"></xref> that re-renders the document — prose, tables, code and box-drawn mermaid
diagrams — as you type. See <xref href="Jumbee.Console.InteractiveSourceEditor" data-throw-if-not-resolved="false"></xref> for the (off-UI-thread, coalesced) sync model.

## Constructors

### <a id="Jumbee_Console_Documents_InteractiveMarkdownExtendedEditor__ctor_System_String_Jumbee_Console_SplitOrientation_System_Int32_"></a> InteractiveMarkdownExtendedEditor\(string, SplitOrientation, int\)

```csharp
public InteractiveMarkdownExtendedEditor(string markdown = "", SplitOrientation orientation = SplitOrientation.Horizontal, int splitPosition = 48)
```
...
Initial document text (both panes start in sync).
...
### <a id="Jumbee_Console_Documents_InteractiveMarkdownExtendedEditor_DiagramStyles"></a> DiagramStyles

Colours / scale for mermaid diagrams embedded in the preview.
...
### <a id="Jumbee_Console_Documents_InteractiveMarkdownExtendedEditor_Preview"></a> Preview

The preview pane rendering the live Markdown (with embedded mermaid diagrams).

```csharp
public MarkdownExtendedViewer Preview { get; }
```
...
### <a id="Jumbee_Console_Documents_InteractiveMarkdownExtendedEditor_PreviewStyles"></a> PreviewStyles

Render styles (heading / code / table colours) for the preview pane.

```csharp
public MarkdownStyles? PreviewStyles { get; set; }
```
...
### <a id="Jumbee_Console_Documents_InteractiveMarkdownExtendedEditor_ApplyPreviewText_System_String_"></a> ApplyPreviewText\(string\)

Pushes the edited <code class="paramref">text</code> into the preview pane's <xref href="Jumbee.Console.MarkdownViewer.Markdown" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Jumbee_Console_Documents_InteractiveMarkdownExtendedEditor_GetHelpInfo"></a> GetHelpInfo\(\)
