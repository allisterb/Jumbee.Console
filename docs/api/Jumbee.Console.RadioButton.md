# <a id="Jumbee_Console_RadioButton"></a> Class RadioButton
...
```csharp
public class RadioButton : ToggleButton, IFocusable
```
...
[ToggleButton.Changed](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_Changed), 
[ToggleButton.HandlesInput](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_HandlesInput), 
[ToggleButton.IsChecked](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_IsChecked), 
[ToggleButton.Text](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_Text), 
[ToggleButton.LabelStyle](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_LabelStyle), 
[ToggleButton.AccentStyle](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_AccentStyle), 
[ToggleButton.MutedStyle](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_MutedStyle), 
[ToggleButton.HoverStyle](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_HoverStyle), 
[ToggleButton.Enabled](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_Enabled), 
[ToggleButton.DisabledStyle](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_DisabledStyle), 
[ToggleButton.Toggle\(\)](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_Toggle), 
[ToggleButton.ApplyTheme\(\)](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_ApplyTheme), 
[ToggleButton.SetGlyphs\(string, string\)](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_SetGlyphs\_System\_String\_System\_String\_), 
[ToggleButton.IndicatorWidth](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_IndicatorWidth), 
[ToggleButton.Render\(RenderOptions, int\)](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_Render\_Spectre\_Console\_Rendering\_RenderOptions\_System\_Int32\_), 
[ToggleButton.OnClick\(Position\)](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_OnClick\_ConsoleGUI\_Space\_Position\_), 
[ToggleButton.OnDoubleClick\(Position\)](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_OnDoubleClick\_ConsoleGUI\_Space\_Position\_), 
[ToggleButton.OnInput\(InputEvent\)](Jumbee.Console.ToggleButton.md\#Jumbee\_Console\_ToggleButton\_OnInput\_ConsoleGUI\_Input\_InputEvent\_), 
...
[ControlExtensions.WithAsciiBorder<RadioButton\>\(RadioButton, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<RadioButton\>\(RadioButton, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<RadioButton\>\(RadioButton, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<RadioButton\>\(RadioButton, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<RadioButton\>\(RadioButton, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<RadioButton\>\(RadioButton, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<RadioButton\>\(RadioButton, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<RadioButton\>\(RadioButton, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<RadioButton\>\(RadioButton, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<RadioButton\>\(RadioButton\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<RadioButton\>\(RadioButton, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<RadioButton\>\(RadioButton, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<RadioButton\>\(RadioButton, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<RadioButton\>\(RadioButton, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<RadioButton\>\(RadioButton, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<RadioButton\>\(RadioButton, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<RadioButton\>\(RadioButton, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<RadioButton\>\(RadioButton, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<RadioButton\>\(RadioButton, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Remarks

Uses the glyph theme's <xref href="Jumbee.Console.IGlyphTheme.RadioSelected" data-throw-if-not-resolved="false"></xref>/
<xref href="Jumbee.Console.IGlyphTheme.RadioUnselected" data-throw-if-not-resolved="false"></xref> markers (by default <code>(●)</code>/<code>( )</code>). Unlike a
<xref href="Jumbee.Console.Checkbox" data-throw-if-not-resolved="false"></xref>, activating a radio button latches it on rather than toggling; mutual exclusion
between several radio buttons is provided by a <xref href="Jumbee.Console.RadioSet" data-throw-if-not-resolved="false"></xref>.

## Constructors

### <a id="Jumbee_Console_RadioButton__ctor_System_String_System_Boolean_"></a> RadioButton\(string, bool\)

Initializes a new <xref href="Jumbee.Console.RadioButton" data-throw-if-not-resolved="false"></xref> with the given label <code class="paramref">text</code> and initial <code class="paramref">isChecked</code> state.

```csharp
public RadioButton(string text = "", bool isChecked = false)
```
...
### <a id="Jumbee_Console_RadioButton_ApplyTheme"></a> ApplyTheme\(\)
...
### <a id="Jumbee_Console_RadioButton_Toggle"></a> Toggle\(\)

Latches the button on (a click never turns a radio button off).
