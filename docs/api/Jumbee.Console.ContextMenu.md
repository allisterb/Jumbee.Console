# <a id="Jumbee_Console_ContextMenu"></a> Class ContextMenu
...
```csharp
public class ContextMenu : Control, IFocusable
```
...
[ControlExtensions.WithAsciiBorder<ContextMenu\>\(ContextMenu, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<ContextMenu\>\(ContextMenu, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<ContextMenu\>\(ContextMenu, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<ContextMenu\>\(ContextMenu, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<ContextMenu\>\(ContextMenu, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<ContextMenu\>\(ContextMenu, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<ContextMenu\>\(ContextMenu, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<ContextMenu\>\(ContextMenu, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<ContextMenu\>\(ContextMenu, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<ContextMenu\>\(ContextMenu\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<ContextMenu\>\(ContextMenu, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<ContextMenu\>\(ContextMenu, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<ContextMenu\>\(ContextMenu, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<ContextMenu\>\(ContextMenu, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<ContextMenu\>\(ContextMenu, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<ContextMenu\>\(ContextMenu, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<ContextMenu\>\(ContextMenu, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<ContextMenu\>\(ContextMenu, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<ContextMenu\>\(ContextMenu, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Remarks

<p>
Up/Down move the highlight (skipping separators and disabled items), Enter/Space choose, Escape or a click outside
dismiss. An item with a <xref href="Jumbee.Console.MenuItem.Submenu" data-throw-if-not-resolved="false"></xref> opens a child menu to its right (Right/Enter or hover to
open, Left to go back); the whole open chain is drawn as this one popup, so submenus nest to any depth. Choosing a
leaf item runs its <xref href="Jumbee.Console.MenuItem.Action" data-throw-if-not-resolved="false"></xref> and raises <xref href="Jumbee.Console.ContextMenu.ItemActivated" data-throw-if-not-resolved="false"></xref>; <xref href="Jumbee.Console.ContextMenu.Closed" data-throw-if-not-resolved="false"></xref> fires
whenever the menu closes.
</p>
<p>
Because the <xref href="Jumbee.Console.Overlay" data-throw-if-not-resolved="false"></xref> hosts a single popup, the menu draws the entire open submenu chain itself: it is
a plain <xref href="Jumbee.Console.Control" data-throw-if-not-resolved="false"></xref> that writes each level's bordered box directly into its buffer (leaving the gaps
between boxes transparent) and routes input to the deepest open level.
</p>

## Constructors

### <a id="Jumbee_Console_ContextMenu__ctor_System_Collections_Generic_IEnumerable_Jumbee_Console_MenuItem__"></a> ContextMenu\(IEnumerable<MenuItem\>\)

Initializes a <xref href="Jumbee.Console.ContextMenu" data-throw-if-not-resolved="false"></xref> from the given top-level items.
...
`items` IEnumerable<[MenuItem](Jumbee.Console.MenuItem.md)\>
...
### <a id="Jumbee_Console_ContextMenu_Items"></a> Items
...
### <a id="Jumbee_Console_ContextMenu_Item_ConsoleGUI_Space_Position_"></a> this\[Position\]
...
### <a id="Jumbee_Console_ContextMenu_ApplyTheme"></a> ApplyTheme\(\)
...
### <a id="Jumbee_Console_ContextMenu_GetHelpInfo"></a> GetHelpInfo\(\)
...
### <a id="Jumbee_Console_ContextMenu_IntrinsicHeight"></a> IntrinsicHeight\(\)
...
### <a id="Jumbee_Console_ContextMenu_IntrinsicWidth"></a> IntrinsicWidth\(\)
...
### <a id="Jumbee_Console_ContextMenu_OnClick_ConsoleGUI_Space_Position_"></a> OnClick\(Position\)
...
### <a id="Jumbee_Console_ContextMenu_OnDoubleClick_ConsoleGUI_Space_Position_"></a> OnDoubleClick\(Position\)
...
### <a id="Jumbee_Console_ContextMenu_OnInput_ConsoleGUI_Input_InputEvent_"></a> OnInput\(InputEvent\)
...
### <a id="Jumbee_Console_ContextMenu_OnMouseLeave"></a> OnMouseLeave\(\)
...
### <a id="Jumbee_Console_ContextMenu_OnMouseMove_ConsoleGUI_Space_Position_"></a> OnMouseMove\(Position\)
...
### <a id="Jumbee_Console_ContextMenu_Render"></a> Render\(\)
...
### <a id="Jumbee_Console_ContextMenu_Show_System_Int32_System_Int32_"></a> Show\(int, int\)

Shows the menu (reset to its root level) in the ambient <xref href="Jumbee.Console.UI.Overlay" data-throw-if-not-resolved="false"></xref> with its top-left at
    (<code class="paramref">x</code>, <code class="paramref">y</code>), then focuses it (no-op before <xref href="Jumbee.Console.UI.Start(Jumbee.Console.ILayout%2cSystem.Int32%2cSystem.Int32%2cSystem.Int32%2cSystem.Boolean%2cConsoleGUI.Api.IConsole%2cJumbee.Console.IInputSource%2cSystem.Boolean)" data-throw-if-not-resolved="false"></xref>).
...
### <a id="Jumbee_Console_ContextMenu_Closed"></a> Closed

Raised whenever the menu closes — whether an item was chosen or it was dismissed.
...
### <a id="Jumbee_Console_ContextMenu_ItemActivated"></a> ItemActivated

Raised when a leaf item is chosen (after its <xref href="Jumbee.Console.MenuItem.Action" data-throw-if-not-resolved="false"></xref> runs).
