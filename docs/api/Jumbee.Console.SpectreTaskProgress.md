# <a id="Jumbee_Console_SpectreTaskProgress"></a> Class SpectreTaskProgress
...
```csharp
public class SpectreTaskProgress : Control, IFocusable
```
...
[ControlExtensions.WithAsciiBorder<SpectreTaskProgress\>\(SpectreTaskProgress, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<SpectreTaskProgress\>\(SpectreTaskProgress, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<SpectreTaskProgress\>\(SpectreTaskProgress, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<SpectreTaskProgress\>\(SpectreTaskProgress, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<SpectreTaskProgress\>\(SpectreTaskProgress, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<SpectreTaskProgress\>\(SpectreTaskProgress, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<SpectreTaskProgress\>\(SpectreTaskProgress, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<SpectreTaskProgress\>\(SpectreTaskProgress, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<SpectreTaskProgress\>\(SpectreTaskProgress, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<SpectreTaskProgress\>\(SpectreTaskProgress\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<SpectreTaskProgress\>\(SpectreTaskProgress, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<SpectreTaskProgress\>\(SpectreTaskProgress, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<SpectreTaskProgress\>\(SpectreTaskProgress, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<SpectreTaskProgress\>\(SpectreTaskProgress, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<SpectreTaskProgress\>\(SpectreTaskProgress, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<SpectreTaskProgress\>\(SpectreTaskProgress, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<SpectreTaskProgress\>\(SpectreTaskProgress, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<SpectreTaskProgress\>\(SpectreTaskProgress, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<SpectreTaskProgress\>\(SpectreTaskProgress, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Constructors

### <a id="Jumbee_Console_SpectreTaskProgress__ctor"></a> SpectreTaskProgress\(\)

Initializes a new <xref href="Jumbee.Console.SpectreTaskProgress" data-throw-if-not-resolved="false"></xref> whose progress refreshes onto the UI thread.
...
### <a id="Jumbee_Console_SpectreTaskProgress_progress"></a> progress

The wrapped Spectre <xref href="Spectre.Console.Progress" data-throw-if-not-resolved="false"></xref> driving the tasks and refresh loop.
...
### <a id="Jumbee_Console_SpectreTaskProgress_HandlesInput"></a> HandlesInput

<a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">false</a>: a passive progress display that takes no keyboard input.
...
### <a id="Jumbee_Console_SpectreTaskProgress_AddColumns_Spectre_Console_ProgressColumn___"></a> AddColumns\(params ProgressColumn\[\]\)

Adds progress <code class="paramref">columns</code> (bar, percentage, spinner, etc.) and returns this wrapper for chaining.
...
### <a id="Jumbee_Console_SpectreTaskProgress_Render"></a> Render\(\)

No-op: the wrapped <xref href="Spectre.Console.Progress" data-throw-if-not-resolved="false"></xref> writes to the buffer from its own refresh loop.

```csharp
protected override void Render()
```

### <a id="Jumbee_Console_SpectreTaskProgress_Start_System_Action_Spectre_Console_ProgressContext__"></a> Start\(Action<ProgressContext\>\)

Runs <code class="paramref">action</code> on a background thread with a progress context to drive the tasks.

```csharp
public Task Start(Action<ProgressContext> action)
```
...
### <a id="Jumbee_Console_SpectreTaskProgress_StartAsync_System_Func_Spectre_Console_ProgressContext_System_Threading_Tasks_Task__"></a> StartAsync\(Func<ProgressContext, Task\>\)

Runs the asynchronous <code class="paramref">action</code> with a progress context to drive the tasks.
...
### <a id="Jumbee_Console_SpectreTaskProgress_StartAsync__1_System_Func_Spectre_Console_ProgressContext_System_Threading_Tasks_Task___0___"></a> StartAsync<T\>\(Func<ProgressContext, Task<T\>\>\)

Runs the asynchronous <code class="paramref">action</code> with a progress context and returns its result.
...
### <a id="Jumbee_Console_SpectreTaskProgress_Validate"></a> Validate\(\)

No-op: the progress display is treated as always needing a repaint.
