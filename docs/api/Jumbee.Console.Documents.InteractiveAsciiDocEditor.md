# <a id="Jumbee_Console_Documents_InteractiveAsciiDocEditor"></a> Class InteractiveAsciiDocEditor
...
```csharp
public class InteractiveAsciiDocEditor : InteractiveSourceEditor, IFocusable
```
...
[ControlExtensions.WithAsciiBorder<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithAsciiBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithBorder<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, BorderStyle?, Color?, Color?, BorderPlacement?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_), 
[ControlExtensions.WithDoubleBorder<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithDoubleBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithFrame<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, ControlFrame\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_Jumbee\_Console\_ControlFrame\_), 
[ControlExtensions.WithFrame<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, BorderStyle?, Offset?, Color?, Color?, string?, Color?, Color?, BorderPlacement?, BorderStyle?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithFrame\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_System\_Nullable\_ConsoleGUI\_Space\_Offset\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_String\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_BorderPlacement\_\_System\_Nullable\_Jumbee\_Console\_BorderStyle\_\_), 
[ControlExtensions.WithHeavyBorder<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeavyBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithHeight<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithHeight\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithMargin<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, int, int, int, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_System\_Int32\_System\_Int32\_System\_Int32\_), 
[ControlExtensions.WithMargin<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithMargin\_\_1\_\_\_0\_System\_Int32\_), 
[ControlExtensions.WithNoBorder<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithNoBorder\_\_1\_\_\_0\_), 
[ControlExtensions.WithRoundedBorder<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithRoundedBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithScrollBarGlyphs<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, ScrollBarGlyphs\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarGlyphs\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarGlyphs\_), 
[ControlExtensions.WithScrollBarStyle<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, ScrollBarStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithScrollBarStyle\_\_1\_\_\_0\_Jumbee\_Console\_ScrollBarStyle\_), 
[ControlExtensions.WithSize<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, int?, int?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSize\_\_1\_\_\_0\_System\_Nullable\_System\_Int32\_\_System\_Nullable\_System\_Int32\_\_), 
[ControlExtensions.WithSquareBorder<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, Color?, Color?\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithSquareBorder\_\_1\_\_\_0\_System\_Nullable\_Jumbee\_Console\_Color\_\_System\_Nullable\_Jumbee\_Console\_Color\_\_), 
[ControlExtensions.WithTitle<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, string\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_), 
[ControlExtensions.WithTitle<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, string, TitleStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitleStyle\_), 
[ControlExtensions.WithTitle<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, string, TitlePos, TitleBorderStyle, TitleColorStyle\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithTitle\_\_1\_\_\_0\_System\_String\_Jumbee\_Console\_TitlePos\_Jumbee\_Console\_TitleBorderStyle\_Jumbee\_Console\_TitleColorStyle\_), 
[ControlExtensions.WithWidth<InteractiveAsciiDocEditor\>\(InteractiveAsciiDocEditor, int\)](Jumbee.Console.ControlExtensions.md\#Jumbee\_Console\_ControlExtensions\_WithWidth\_\_1\_\_\_0\_System\_Int32\_)

## Remarks

A draggable
<xref href="Jumbee.Console.SplitPanel" data-throw-if-not-resolved="false"></xref> divider sits between them. See <xref href="Jumbee.Console.InteractiveSourceEditor" data-throw-if-not-resolved="false"></xref> for the (off-UI-thread,
coalesced) sync model.

## Constructors

### <a id="Jumbee_Console_Documents_InteractiveAsciiDocEditor__ctor_System_String_Jumbee_Console_SplitOrientation_System_Int32_"></a> InteractiveAsciiDocEditor\(string, SplitOrientation, int\)

```csharp
public InteractiveAsciiDocEditor(string asciiDoc = "", SplitOrientation orientation = SplitOrientation.Horizontal, int splitPosition = 48)
```
...
Initial document source (both panes start in sync).
...
### <a id="Jumbee_Console_Documents_InteractiveAsciiDocEditor_Preview"></a> Preview

The preview pane rendering the live AsciiDoc.

```csharp
public AsciiDocViewer Preview { get; }
```
...
### <a id="Jumbee_Console_Documents_InteractiveAsciiDocEditor_PreviewStyles"></a> PreviewStyles

Render styles (heading / code / admonition colours) for the preview pane.

```csharp
public AsciiDocStyles? PreviewStyles { get; set; }
```
...
### <a id="Jumbee_Console_Documents_InteractiveAsciiDocEditor_ApplyPreviewText_System_String_"></a> ApplyPreviewText\(string\)

Pushes the edited <code class="paramref">text</code> into the preview pane's <xref href="Jumbee.Console.Documents.AsciiDocViewer.AsciiDoc" data-throw-if-not-resolved="false"></xref>.
...
### <a id="Jumbee_Console_Documents_InteractiveAsciiDocEditor_GetHelpInfo"></a> GetHelpInfo\(\)
